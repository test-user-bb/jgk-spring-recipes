...
public class ReleaseUserRepositoryJpaInJavaTreeTest {
...
//			releaseUserRepository.save(releaseUser);
	...
	@Component(value="transTesterTransInJavaTreeTester")
	static class TransInJavaTreeTester {
		@Transactional(propagation=Propagation.MANDATORY)
