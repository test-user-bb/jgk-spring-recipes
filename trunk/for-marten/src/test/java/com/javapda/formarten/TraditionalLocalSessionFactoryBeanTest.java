...
/**
 * This tests the use of a traditional SessionFactory (aka: org.springframework.orm.hibernate4.LocalSessionFactoryBean)
 * Nothing special here, but it exercises the same DAO (FootballPlayerDao).
 * @author jkroub
 *
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations={"classpath:LocalSessionFactoryBean-test-spring-main-config.xml"})
@TransactionConfiguration(transactionManager = "transactionManager", defaultRollback = true)
@Transactional
public class TraditionalLocalSessionFactoryBeanTest {
