...
@ContextConfiguration(locations={"classpath:EntityManagerFactory-derived-SessionFactory-test-spring-main-config.xml"})
@TransactionConfiguration(transactionManager = "transactionManager", defaultRollback = true)
@Transactional
public class EntityManagerFactoryDerivedSessionFactoryTest {
